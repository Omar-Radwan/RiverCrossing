...
public Level2() {
	...
	objects.add(new Sprite(new Image("file:///C:/Users/lenovo/git/RiverCrossing/src/gui/related/farmer4.png", 70,
			70, false, false)));
	objects.add(new Sprite(new Image("file:///C:/Users/lenovo/git/RiverCrossing/src/gui/related/animallevel2.png", 70,
			70, false, false)));
...
/*
public NewLevel2(Stage stage1) {
stage = stage1;
}


public void makeNewGame2() {
double posX = 0.0;
double posY = 0.0;
...
objects[0] = new Sprite(new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/background.jpg"));
objects[0].render(gc);

// boat
objects[1] = new Sprite(new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/boat1.png", 170,
170, false, false));
objects[1].setPositionX(400);
objects[1].setPositionY(500);
objects[1].render(gc);

// first farmer 90kg
objects[2] = new Sprite(new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/farmer1.png", 80,
80, false, false));
...
objects[3] = new Sprite(new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/farmer3.png", 110,
110, false, false));
...
// third farmer 60kg
objects[4] = new Sprite(new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/farmer2.png", 70,
70, false, false));
...
// fourth farmer 40kg
objects[5] = new Sprite(new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/farmer4.png", 70,
70, false, false));
...
objects[6] = new Sprite(new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/horse.png", 70,
70, false, false));
...
ImageView move = new ImageView("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/doublearrow.png");

// moving
Button moving = new Button("", move);
move.setFitWidth(40);

move.setFitHeight(40);
menu.getChildren().add(moving);
//score label
...
for (int j = 1; j < 7; j++) {
if (objects.get(j).intersects(objects.get(j))) {
...
// weight menu
/*Image image = new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/farmer1log.png", 30, 30,
false, false);
Label label = new Label("90kg");
label.setFont(Font.font("Verdana", FontWeight.BOLD, 10));
label.setGraphic(new ImageView(image));
...
Image image2 = new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/farmer3log.png", 30, 30,
false, false);
Label label2 = new Label("80kg");
label2.setFont(Font.font("Verdana", FontWeight.BOLD, 10));
label2.setGraphic(new ImageView(image2));
...
Image image3 = new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/farmer2log.png", 30, 30,
false, false);
Label label3 = new Label("60kg");
label3.setFont(Font.font("Verdana", FontWeight.BOLD, 10));
label3.setGraphic(new ImageView(image3));
...
Image image4 = new Image("file:///Users/esraayahia/git/RiverCrossing/src/gui/related/farmer4log.png", 30, 30,
false, false);
Label label4 = new Label("40kg");
label4.setFont(Font.font("Verdana", FontWeight.BOLD, 10));
label4.setGraphic(new ImageView(image4));
...
Scene level2 = new Scene(root, 800, 800);
level2.setOnMousePressed(new EventHandler<MouseEvent>() {
...
if(objectNumber==2)
{
objects[2].setPositionX(60);
objects[2].setPositionY(581);

}
if(objectNumber==3)
{
objects[3].setPositionX(50);
objects[3].setPositionY(550);

}
if(objectNumber==4)
{
objects[4].setPositionX(40);
objects[4].setPositionY(570);

}
if(objectNumber==5)
{
objects[5].setPositionX(30);
objects[5].setPositionY(570);

}
if(objectNumber==6)
{
objects[6].setPositionX(0);
